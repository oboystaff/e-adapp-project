$(document).ready(function () {
   ...
   $('.generate_report').on('click', function(event) {
        ...
        load_data(from_date, to_date, cubic_meters, product_type);
    });

    function load_data(from_date = '', to_date = '', cubic_meters = '', product_type = '') {
        var url = $("input[name='verification-report_url']").attr("url");
