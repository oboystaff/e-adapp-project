$(document).ready(function () {
   ...
   $('.generate_report').on('click', function(event) {
        ...
        var waste_type = $('select[name="waste_type"]').val();

        $('#style-2').DataTable().destroy();
        load_data(from_date, to_date, waste_type);
    });

    function load_data(from_date = '', to_date = '', waste_type = '') {
        ...
        try {
            $('#style-2').DataTable({
               ...
               columns: [
                    ...
                    {data: 'picking_agent', name: 'picking_agent'},
                    ...
                    {data: 'validated_by', name: 'validated_by'},
