                            ...
                            <div class="tab-pane fade show active" id="item-two-tab-icon-pane" role="tabpanel"
                                ...
                                <div class="row">
                                    <form class="row g-3 needs-validation" method="POST"
                                        action="{{ route('farmers.store') }}" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="col-md-3">
                                            <div class="col-md-12">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ $farmer->firstname }}" readonly>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ $farmer->birth_place }}" readonly>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ $farmer->house_number }}" readonly>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ $farmer->occupation }}" readonly>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ $farmer->religion }}" readonly>
                                        ...
                                        <div class="col-md-3">
                                            <div class="col-md-12">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ $farmer->lastname }}" readonly>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ $farmer->community }}" readonly>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ $farmer->district }}" readonly>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ $farmer->marital_status }}" readonly>
                                        ...
                                        <div class="col-md-3">
                                            <div class="col-md-12">
                                                ...
                                                <textarea class="form-control @error('bio') is-invalid @enderror" id="exampleFormControlTextarea1" rows="5"
                                                    name="bio" readonly>{{ $farmer->bio }}</textarea>
