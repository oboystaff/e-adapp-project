...
<head>
    ...
    <link href="{{ asset('assets/layouts/modern-dark-menu/css/light/plugins.css') }}" rel="stylesheet"
        type="text/css" />
...
<body class="layout-boxed" data-bs-spy="scroll" data-bs-bs-target="#navSection" data-bs-offset="140">
    ...
    <div class="header-container container-xxl">
        <header class="header navbar navbar-expand-sm expand-header">
            ...
            <div style="text-align:left;"><img src="{{ asset('assets/images/3sdcl.png') }}" alt="logo"
                    width="60" height="40" style="float:left" /></div>
            ...
            <nav id="sidebar">
                ...
                <div class="navbar-nav theme-brand flex-row  text-center">
                    <div class="nav-logo">
                        <div class="nav-item">
                            <a href="#">
                                <img src="{{ asset('assets/images/e-adapp-logo.png') }}" alt="logo"
                                    width="150" height="70">
                            </a>
                        </div>
                    </div>
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu menu-heading">
                        <div class="heading"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            ...
                            </svg><span>MAIN NAVIGATION</span></div>
                    </li>
                    ...
                    <li class="menu">
                        <a href="{{ route('farmers.index') }}" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
        ...
        <div id="content" class="main-content">
            ...
            <div class="footer-wrapper">
                <div class="footer-section f-section-1">
                    <p class="">Copyright © <span class="dynamic-year"><?php echo date('Y'); ?></span> <a
                            target="_blank" href="#">E - Adapp Limited</a>, All rights
                        reserved.</p>
                </div>
